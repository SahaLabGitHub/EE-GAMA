...
This repository contains all input files for neutral water clusters and protonated (charged) water clusters, along with a part of Perl scripts for performing EE-GAMA calculations (script_EE-GAMA.pl) and non-embedded GAMA calculations (script_GAMA.pl).
